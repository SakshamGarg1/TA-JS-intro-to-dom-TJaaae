...
allHrsArray.forEach(elm => elm.style.border="antiquewhite");
...
// Change the inner text of para to "querySelector returns an element you can 
//maupulate but querySelectorAll returns the collection of elements in array kind of structure."
